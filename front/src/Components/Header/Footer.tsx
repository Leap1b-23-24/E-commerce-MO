    ...
    <footer className="w-screen  bg-[#12A795]">
      ...
      >
        ...
        <div className="flex flex-col  gap-6 ">
          <ul className="flex min-w-[792px] m-auto justify-between text-white text-base font-[590] ">
          ...
          <div className="flex-col gap-4 items-center justify-center text-center text-white text-base font-normal">
