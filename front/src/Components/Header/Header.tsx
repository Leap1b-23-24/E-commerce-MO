  ...
  return (
    ...
    <div className="bg-teal-500 w-full">
      <div className="flex w-full justify-center items-center gap-16">
        ...
        <div className="flex relative w-[300px] h-[48px] group justify-center items-center z-1001 pl-2 bg-white rounded-lg">
          <span className="flex absolute left-0 bg-transparent rounded text-base text-gray-600">
